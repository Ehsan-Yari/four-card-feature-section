function App() {
  return (
    <div className="container mx-auto my-20 grid  max-w-7xl justify-center">
      <div className="mx-8">
        <header className="mx-auto mb-20 max-w-xl text-center tracking-wide md:mb-16 pt-2">
        ...
        <main>
          ...
          >
            <div className="md:row-span-2">
              ...
              <div className="flex flex-col rounded-lg rounded-t-md border-t-4 border-primary-cyan bg-white p-7 shadow-2xl">
                ...
                <div className="self-end">
                  <img className='w-14' src="/icon-supervisor.svg" alt="" />
                </div>
              </div>
            </div>
            {/* card-2 */}
            <div className="flex flex-col rounded-lg rounded-t-md border-t-4 border-primary-red bg-white  p-7 shadow-xl">
              ...
              {/* card image */}
              <div className="self-end">
                <img className='w-14' src="/icon-team-builder.svg" alt="" />
              </div>
            </div>
            {/* card-3 */}
            <div className="flex flex-col rounded-lg rounded-t-md border-t-4 border-primary-orange bg-white  p-7 shadow-xl">
              ...
              {/* card image */}
              <div className="self-end">
                <img className='w-14' src="/icon-karma.svg" alt="" />
              </div>
            </div>
            <div className="md:row-span-2">
              {/* card-4 */}
              <div className="flex flex-col rounded-lg rounded-t-md border-t-4 border-primary-blue bg-white p-7 shadow-xl">
                ...
                {/* card image */}
                <div className="self-end">
                  <img className='w-14' src="/icon-calculator.svg" alt="" />
                </div>
              </div>
            </div>
          </section>
